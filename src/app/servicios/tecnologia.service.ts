...
export class TecnologiaService {
  ...
  addItem(datosFormulario:any,idpersona:any):Observable<any>{
     ...
     return this.http.post(this.api+"/new/tecnologia/"+idpersona,datosFormulario);
  ...
  eliminarItem(idpersona:any,idItem:any):Observable<any>{
    ...
    return this.http.delete(this.api+"/eliminar/tecnologia/"+idpersona+"/"+idItem);
  }

  editItem(datosFormulario:any):Observable<any>{

    return this.http.put(this.api+"/editar/tecnologia",datosFormulario);
  }

  buscarItem(idItem: any):Observable<any>{ 
    return this.http.get(this.api+"/ver/tecnologia/"+idItem); 
  }
}
